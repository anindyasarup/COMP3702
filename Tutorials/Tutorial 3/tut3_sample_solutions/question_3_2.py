...
def main():
    cost_map = [[1, 1, 1, 5, 5, 5, 5, 1, None], [1, 1, 1, 5, 5, 5, 5, 1, 1],
                [1, 1, 10, 10, 10, 10, 10, 1, 1],
                [1, 1, 1, 10, 10, 10, 10, 1, 1], [1, 1, 1, 1, 1, 10, 10, 1, 1],
                [1, 1, 1, 1, 1, 10, 10, 1, 1], [1, 1, 1, 1, 10, 10, 10, 1, 1],
                [1, 1, 1, 10, 10, 10, 10, 1, 1], [0, 1, 1, 1, 1, 1, 1, 1, 1]]
    env_config = {'nrow': 9, 'ncol': 9, 'obstacle_map': None,
                  'start_coord': (8, 0), 'goal_coord': (0, 8),
                  'cost_map': cost_map}
...
def question_3_2_a(start, goal, env, printing=True):
    if printing:
        print(
            'a) Run BFS for this problem, reusing your answer from Question 1')
...
def question_3_2_c(start, goal, env):
    ...
    keys = ['nvextex_explored_(with_duplicates)',
            'nvertex_in_fringe_at_termination']
